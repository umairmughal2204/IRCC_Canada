  ...
  const handleClick = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            ...
            {/* Main Content (Content left + Sidebar right) */}
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex-1 p-2 order-1 md:order-1">
                        ...
                        <p className="text-gray-800 mb-4">
                            You last signed in with your GCKey on <strong>Thursday, August 28, 2025 at 15:21:28 ET.</strong>
                        </p>

                        <p className="text-gray-800 mb-6">
                            From this page you can{" "}
                            <a href="#" className="text-blue-800 hover:underline">Change Your Password</a>,{" "}
                            <a href="#" className="text-blue-800 hover:underline">Change Your Recovery Questions</a>,{" "}
                            <a href="#" className="text-blue-800 hover:underline">Manage Your Email Address</a> or{" "}
                            <a href="#" className="text-blue-800 hover:underline">Revoke Your GCKey</a>.
                        </p>

                        <p className="text-gray-800 mb-4">
                            To help protect your information, please remember to sign out and close your browser before leaving this computer unattended.
                        </p>
                    ...
                    {/* Sidebar: Options Box (now on right) */}
